...
class TransitionBtnPressFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        redButton.setOnClickListener {
            wlcpGameClient.sendSingleButtonPress(1) // Call the backend API
        }

        greenButton.setOnClickListener {
            wlcpGameClient.sendSingleButtonPress(2)
        }

        blueButton.setOnClickListener {
            wlcpGameClient.sendSingleButtonPress(3)
        }

        blackButton.setOnClickListener {
            wlcpGameClient.sendSingleButtonPress(4)
        }
    }
}
